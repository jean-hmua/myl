...
main_user = User.create(email: 'user@myly.com', password: '000000')
puts "🖐 created user #{main_user} \n"

user_dummy = User.create(email: 'dummy@dummy.com', password: '000000')
user_dummy2 = User.create(email: 'dummy2@dummy.com', password: '000000')
